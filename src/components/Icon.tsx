...
/* ========================================
   Custom SVG Icons for Teknao
   Professional replaces emojis
   ======================================== */
...
export function IconHospital({ className = "", size = 24 }: IconProps) {
  return (
    <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <path d="M19 12H5" />
      <path d="M12 12v-7a2 2 0 00-2-2H8" />
      <path d="M12 12v7" />
...
export function IconShoppingCart({ className = "", size = 24 }: IconProps) {
  return (
    <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
...
export function IconFactory({ className = "", size = 24 }: IconProps) {
  return (
    <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <path d="M2 20h20" />
      <path d="M10 20v-4" />
      <path d="M14 20v-6" />
      <path d="M18 20v-2" />
      <path d="M4 20v-6a2 2 0 012-2h1" />
      <path d="M2 20V9a2 2 0 012-2h7" />
      <path d="M9 6V4" />
      <path d="M13 8V4" />
    </svg>
  );
...
export function IconHardHat({ className = "", size = 24 }: IconProps) {
  return (
    <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <path d="M2 18a1 1 0 011-1h18a1 1 0 011 1v2a1 1 0 01-1 1H3a1 1 0 01-1-1v-2z" />
      <path d="M10 10V5a1 1 0 011-1h2a1 1 0 011 1v5" />
      <path d="M4 15v-3a6 6 0 016-6h4a6 6 0 016 6v3" />
    </svg>
  );
}

export function IconTruck({ className = "", size = 24 }: IconProps) {
  return (
    <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
